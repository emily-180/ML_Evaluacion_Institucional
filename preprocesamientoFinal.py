...
dados = pd.read_csv("static/data/[Copia - Editada] Questionario 2024_2 - Base Formatada - Página1.csv")
...
dados.to_csv('dados_tratados_final.csv', index=False)

print("Arquivo 'dados_tratados_final.csv' gerado com sucesso!")
